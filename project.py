...
def user_input_features():
        ...
        age_range = st.sidebar.slider('Age', 29.0,53.0,43.9)
...
load_clf = pickle.load(open('/Users/husam/Desktop/Decision Support Systems Work/project-code/withkids_clf.pkl', 'rb'))
